 ...
 */
	...
	public AdminSuccess() {
		...
		lblAdminSection.setFont(new Font("Sans-Serif", Font.PLAIN, 22));
		lblAdminSection.setForeground(Color.BLUE);
		
		JButton btnNewButton = new JButton("Add Librarian");
		btnNewButton.setFont(new Font("Sans-Serif", Font.PLAIN, 15));
		...
		btnDeleteLibrarian.setFont(new Font("Sans-Serif", Font.PLAIN, 15));
